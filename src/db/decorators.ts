 ...
 * The method should already have signal?: AbortSignal as its last parameter
 */
export function abortable<This extends DexieWithTasks, Args extends unknown[], Return>(
