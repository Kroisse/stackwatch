...
INSERT OR IGNORE INTO tasks (
    id, name, context, start_time, total_duration, stack_position, is_active, created_at, updated_at
) VALUES (
    1, 'Idle', 'Default idle state', datetime('now'), 0, 0, 1, datetime('now'), datetime('now')
);
